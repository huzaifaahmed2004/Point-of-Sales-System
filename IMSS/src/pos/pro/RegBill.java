 ...
 * @author Go
 */
public class RegBill extends javax.swing.JPanel {
...
public void tot() {
    try {
        ...
        if (!paid_amt.getText().isEmpty()) {
            paidValue = Double.parseDouble(paid_amt.getText());
        }

        // Calculate due amount
        double due = paidValue - discounted;
    ...
    private void initComponents() {
        ...
        Discounted1 = new javax.swing.JLabel();
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(c_search_tbl1, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE))
                        ...
                        .addComponent(customcombo, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(customcombo, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel2)
                            .addComponent(inid))
        ...
        paid_amt.setText("0");
        paid_amt.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                paid_amtMouseClicked(evt);
            }
        });
        ...
        Discounted1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        Discounted1.setText("00.00");
        Discounted1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(Discounted, javax.swing.GroupLayout.DEFAULT_SIZE, 129, Short.MAX_VALUE)
                    .addComponent(bill_tot, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(Discounted1, javax.swing.GroupLayout.DEFAULT_SIZE, 129, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(Discounted1, javax.swing.GroupLayout.DEFAULT_SIZE, 28, Short.MAX_VALUE))
                .addGap(2, 2, 2)
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // data send to databace
                String cname = (String) customcombo.getSelectedItem();
                if(cname==null){cname="N/A";}
        ...
        String date = currentDate.format(formatter);
          ...
          if(rc!=0){
            ...
            Statement updateProductStatement = db.mycon().createStatement();
        updateProductStatement.executeUpdate("UPDATE products SET pQuantity = pQuantity - " + qty + " WHERE pName = '" + name + "' AND pCompany = '" + comp + "'AND pSize = '" + size + "'");
        
                // cart DB
             Statement s = db.mycon().createStatement();
             s.executeUpdate(" INSERT INTO cart (INID, pName, pCompany,pSize, pQuantity, pUPrice, pTPrice,Date) VALUES ('"+inid.getText()+"','"+name+"','"+comp+"','"+size+"','"+qty+"','"+un_price+"','"+tot_price+"','"+date+"') ");
...
//            }
            ...
            Double tot = Double.valueOf(balance.getText());
             // paid check
////             
//             Double tot = Double.valueOf(bill_tot.getText());
        ...
        updateStatement.executeUpdate("UPDATE customers SET cusBalance = cusBalance + " + tot + " WHERE cusName = '" + cname +  "'");
            }
...
//1 page
if (rows <= 22) {
    BILL b = new BILL(ii, CI,1,0);
    JPanel p = b.getJPanel();
    panelsToPrint.add(p);
} else
    //2page
    if (rows > 22 && rows <= 44) {
    BILL a = new BILL(ii, CI,1,0);
    JPanel p = a.getJPanel();
    panelsToPrint.add(p);

    BILL b = new BILL(ii, CI + 22,2,0);
...
//dt.setValueAt(updatedPrice, existingRow, 5);
    ...
    private void paid_amtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_paid_amtMouseClicked
          paid_amt.setText("");
    }//GEN-LAST:event_paid_amtMouseClicked
    ...
    private javax.swing.JLabel Discounted1;
